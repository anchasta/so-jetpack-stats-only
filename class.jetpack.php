...
*/
				...
				<div class="jetpack-text-container">
					<h4>
						<?php if ( 1 == Jetpack_Options::get_option( 'activated' ) ) : ?>
							<p><?php _e( '<strong>Almost ready</strong> &#8211; A connection to WordPress.com is needed to enable the Stats module.', 'jetpack' ); ?></p>
						<?php else : ?>
							<p><?php _e( '<strong>SO Jetpack Stats Only is installed</strong>.', 'jetpack' ) ?></p>
						<?php endif; ?>
					</h4>
				</div>
	...
	function network_connect_notice() {
		...
		<div id="message" class="updated jetpack-message">
			<div class="squeezer">
				<h4><?php _e( '<strong>SO Jetpack Stats Only is activated!</strong> Each site on your network must be connected individually by an admin on that site.', 'jetpack' ) ?></h4>
			</div>
		</div>
		<?php
	}
	...
	function admin_page_load() {
		...
		case 'authorized' :
			$this->message  = __( '<strong>You&#8217;re connected to WordPress.com now and can start using the Stats Module.</strong> ', 'so-jetpack-stats-only' );
			break;
		...
		<div class="wrap" id="jetpack-settings">
			...
			<div id="jp-header"<?php if ( $is_connected ) : ?> class="small"<?php endif; ?>>
				<div id="jp-clouds">
					...
					<?php endif; ?>
					<h3><?php _e( 'Jetpack by WordPress.com forked by SO WP', 'jetpack' ) ?></h3>
					<?php if ( ! $is_connected ) : ?>
					<div id="jp-notice">
						<p><?php _e( 'SO Jetpack Stats Only is a fork of Jetpack 2.9.3 and gives you Jetpack with only the Stats module.', 'so-jetpack-stats-only' ); ?></p>
					</div>
					<?php endif; ?>
				</div>
			</div>
			...
			?>
				...
				<div id="message" class="updated jetpack-message jp-connect" style="display:block !important;">
					...
					<div class="jetpack-wrap-container">
						<div class="jetpack-text-container">
							<h4>
								<p><?php _e( 'To enable the Stats Module you&#8217;ll need to connect your website to WordPress.com using the button to the right. ', 'jetpack' ) ?></p>
							</h4>
						</div>
						<div class="jetpack-install-container">
							<p class="submit"><a href="<?php echo $this->build_connect_url() ?>" class="button-connector" id="wpcom-connect"><?php _e( 'Connect to WordPress.com', 'jetpack' ); ?></a></p>
			...
			<?php if ( Jetpack::is_active() && !Jetpack::is_development_mode() && ! $is_user_connected ) : ?>
				...
				<div id="message" class="updated jetpack-message jp-connect" style="display:block !important;">
					<div class="jetpack-wrap-container">
						<div class="jetpack-text-container">
							<h4>
								<p><?php _e( 'To enable the Stats Module you&#8217;ll need to link your account here to your WordPress.com account using the button to the right.', 'jetpack' ) ?></p>
							</h4>
						</div>
						<div class="jetpack-install-container">
			...
			<div class="author postbox">
				...
				<div class="inside">
					...
					<ul>
						<li><a href="https://senlinonline.com/plus/" target="_blank" title="SO PLUS, Premium WordPress Plugins by Senlin Online"><?php _e( 'SO PLUS', 'so-jetpack-stats-only' ); ?></a></li>
						<li><a href="http://senlinonline.com/" target="_blank" title="Senlin Online"><?php _e( 'Senlin Online', 'so-jetpack-stats-only' ); ?></a></li>
						<li><a href="http://wpti.ps/" target="_blank" title="WP TIPS"><?php _e( 'WP Tips', 'so-jetpack-stats-only' ); ?></a></li>
